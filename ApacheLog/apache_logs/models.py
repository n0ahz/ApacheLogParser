...
class ApacheLog(models.Model):
    ...
    response_bytes = models.DecimalField(decimal_places=6, max_digits=100, null=True)
    ...
    time_second = models.DecimalField(decimal_places=6, max_digits=100, null=True)
    time_millisecond = models.DecimalField(decimal_places=6, max_digits=100, null=True)
